...
RUN yum install -y php71w php71w-cli php71w-opcache php71w-common php71w-mysqlnd php71w-mbstring php71w-xml php71w-opcache php71w-pecl-apcu php71w-pecl-xdebug
